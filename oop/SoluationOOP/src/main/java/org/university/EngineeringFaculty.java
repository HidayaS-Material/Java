...
public class EngineeringFaculty extends  University{
        private String facultyName;
        private int numOfStudents;
        private ArrayList<String> departments;
        private int numOfStaff;

        public EngineeringFaculty(String name, String location, String flagColour, String facultyName, int numOfStudents, ArrayList<String> departments, int numOfStaff) {
